...
float sumaMercado (nodoMercado *);
float cantidadMercado (nodoMercado *);
float promedioMercado (nodoMercado *);
float medianaMercado (nodoMercado *);
int mayorCalificacion (nodoMercado *);
int menorCalificacion (nodoMercado *);
void mayorMenorMercado (nodoMercado *);
